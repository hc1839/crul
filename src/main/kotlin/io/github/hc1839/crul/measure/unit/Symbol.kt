...
import io.github.hc1839.crul.measure.unit.parse.Production
import io.github.hc1839.crul.measure.unit.parse.TokenIterator
...
private object UcumSymbolStore {
     ...
     *  resource.
     */
    val path: String = "/io/github/hc1839/crul/measure/unit/ucum-symbols.json"
...
private object UnitOfMeasureAvsc {
    val schema: Schema = Schema.Parser().parse(
       ...
       |{
       |    "type": "record",
       |    "namespace": "io.github.hc1839.crul.measure.unit",
       |    "name": "UnitOfMeasure",
       |    "fields": [
